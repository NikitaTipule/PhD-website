  ...
  render() {
    ...
    return (
      <>
        ...
        <Container component="main" max-width="sm" style={{ marginTop: "90px"}}>
      ...
      >
        ...
        <div class="container-tab">
          ...
          {this.state.links.map((item)=>(
            ...
            <div class="col col-2" data-label="Link"><a href={{}}>{item.link}</a></div>
            <Button><div class="col col-3" data-label=""><DeleteIcon /></div></Button>
            </li>
          ))}
